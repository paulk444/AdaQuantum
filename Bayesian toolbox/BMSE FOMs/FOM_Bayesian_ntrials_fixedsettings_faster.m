function FOM_mse_final = FOM_Bayesian_ntrials_fixedsettings_faster(density_matrix_single_mode)
...
% Speed settings
tau_mc = 50;        % Monte Carlo sample size, Jesus had 1250
dim_theta = 100;     % Dimensions of the theta space to be integrated over, Jesus had 1250
