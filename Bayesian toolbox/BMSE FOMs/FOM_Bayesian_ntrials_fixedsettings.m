function FOM_mse_final = FOM_Bayesian_ntrials_fixedsettings(density_matrix_single_mode)
...
dim_theta = 300;     % Dimensions of the theta space to be integrated over, Jesus had 1250
